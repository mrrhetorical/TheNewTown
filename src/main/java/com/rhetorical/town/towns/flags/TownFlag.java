...
public enum TownFlag {
	NO_PVP(true, "PvP", "True: PvP is disabled in town."), // Disables pvp within the town border. (default: true) // done
	...
	ANIMAL_ABUSE(false, "Kill Passive Animals", "True: Players may kill passive mobs."), // Disables animal abuse against friendly animals (default: false) // done
